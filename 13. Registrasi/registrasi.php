    ...
    <form action="" method="POST">
        <table>
            ...
            <tr>
                ...
                <td>: <input type="password" name="password2" id="password2" autocomplete="off" required></td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;</td>
            </tr>
            <tr>
                <td colspan="2"><button type="submit" name="register">Registrasi</button></td>
            </tr>
        </table>
    </form>
</body>
