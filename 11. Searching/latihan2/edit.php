...
<head>
    ...
    <title>SCKI | Edit Data Mahasiswa</title>
    <style>
        * {
            font-family: 'Arial';
        }
...
<body>
    ...
    <form action="" method="POST">
        <table>
            <tr>
                <td><input type="hidden" name="id" id="id" readonly value="<?= $mhs['id']; ?>"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>: <input type="text" name="gambar" id="gambar" value="<?= $mhs['gambar']; ?>" autocomplete="off" required></td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;</td>
            </tr>
