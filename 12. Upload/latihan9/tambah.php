    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <table>
            ...
            <tr>
                ...
                <td>: <input type="text" name="nim" id="nim" autocomplete="off"></td>
            </tr>
            <tr>
                <td><label for="prodi">Prodi</label></td>
                <td>: <input type="text" name="prodi" id="prodi" autocomplete="off"></td>
            </tr>
            <tr>
                <td><label for="semester">Semester</label></td>
                <td>: <input type="text" name="semester" id="semester" autocomplete="off"></td>
            </tr>
            <tr>
