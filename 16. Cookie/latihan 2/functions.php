...
function upload() {
    ...
    if ( $ukuranFile > 1000000 ) {
        echo "
            <script>
                alert('Ukuran file terlalu besar, gunakan file berukuran < 1MB!');
            </script>
        ";
        return false;
    }
    ...
    $ekstensiGambar = stripcslashes(end($ekstensiGambar));
...
function register($data) {
    ...
    mysqli_query($dbconn, "INSERT INTO pengguna VALUES
        ('', '$username', '$password')
    ");
